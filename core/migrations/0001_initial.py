# Generated by Django 6.0.1 on 2026-01-30 11:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('staff', 'Staff'), ('admin', 'Admin')], default='student', help_text='User role determines access level and dashboard redirect', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('department', models.CharField(blank=True, max_length=100)),
                ('subjects', models.CharField(blank=True, help_text='Comma-separated list of subjects', max_length=255)),
